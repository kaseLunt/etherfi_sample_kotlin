...
android {
    namespace = "com.babel.etherfiportfoliotracker"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.babel.etherfiportfoliotracker"
        minSdk = 28
        targetSdk = 36
        versionCode = 1
        versionName = "1.0"
        ...
        // Expose API key in BuildConfig
        val etherscanApiKey = properties.getProperty("ETHERSCAN_API_KEY") ?: ""
